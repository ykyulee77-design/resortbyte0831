...
interface NaverConsentModalProps {
  isOpen: boolean;
  onClose: () => void;
  onAgree: () => void;
  selectedRole: string;
...
const NaverConsentModal: React.FC<NaverConsentModalProps> = ({
  isOpen,
  onClose,
  onAgree,
  selectedRole
        ...
        <div className="p-6 space-y-6">
          <div className="text-center">
            ...
            <p className="text-sm text-gray-600">
              리조트바이트 서비스 이용을 위해 네이버에서 다음 정보를 제공받습니다.
            </p>
          </div>
          ...
          <div className="bg-gray-50 rounded-lg p-4">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-gray-900">휴대전화번호</span>
              </div>
            </div>
          </div>
...
export default NaverConsentModal;
